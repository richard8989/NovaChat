...
if(isset($_POST['submit2']))
  {	
	...
	$sql="UPDATE users SET first_name=(:fname), last_name=(:lname) WHERE id=(:idedit)";
	$query = $dbh->prepare($sql);
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading"><?php echo htmlentities($_SESSION['name']); ?></div>
...
<div class="form-group">
	...
	<div class="col-sm-3">
	<input type="text" name="first_name" class="form-control" required value="<?php echo htmlentities($result->first_name);?>">
	</div>

	<label class="col-sm-2 control-label">Last name</label>
	<div class="col-sm-3">
	<input type="text" name="last_name" class="form-control" required value="<?php echo htmlentities($result->last_name);?>">
	</div>
</div>
...
<div class="form-group">
	<div class="col-sm-8 col-sm-offset-2">
		<button class="btn btn-primary" name="submit2" type="submit">Save Changes</button>
	</div>
</div>
